...
class FinancialInsights:
    ...
    def get_category_breakdown(self) -> pd.DataFrame:
        ...
        category_summary.columns = ['total_spent', 'transaction_count', 'avg_transaction', 'count']
        category_summary = category_summary.sort_values('total_spent', ascending=False)
        category_summary['percentage'] = (category_summary['total_spent'] / category_summary['total_spent'].sum() * 100).round(1)
